...
function Home() {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900">
      ...
      <div className="h-[calc(100vh-64px)] mx-auto px-6 pt-10 pb-24 sm:pb-32 lg:flex lg:py-40 lg:px-8">
        <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            ...
            deliverables and drive projects forward from concept to launch. A
            life long learner and firm believer in leaving code better than you
            found it.
          </p>
